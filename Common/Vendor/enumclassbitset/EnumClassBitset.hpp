...
//	Modified slightly by Benjamin Edwards to fit project naming conventions
//
...
// IMPORTANT: DO NOT USE WITHIN A NAMESPACE
#define ENABLE_ENUM_CLASS_BITMASK(T) template<> \
